        ...
        <div class="row">
          ...
          <div class="col-lg-6 col-6">
            ...
            <div class="small-box text-bg-primary">
              <div class="inner">
                <h3>Mahasiswa Jurusan Sistem Informasi</h3>
              </div>
              <svg
          ...
          <div class="col-lg-6 col-6">
            ...
            <div class="small-box text-bg-dark">
              <div class="inner">
                <h3>Mahasiswa Jurusan Informatika</h3>
              </div>
              <svg
                class="small-box-icon"
                fill="currentColor"
         ...
         <div class="col-lg-6 col-6">
            ...
            <div class="small-box text-bg-success">
              <div class="inner">
                <h3>Mahasiswa Jurusan Manajemen</h3>
              </div>
              <svg
                class="small-box-icon"
                fill="currentColor"
          ...
          <div class="col-lg-6 col-6">
            ...
            <div class="small-box text-bg-danger">
              <div class="inner">
                <h3>Mahasiswa Jurusan Akuntansi</h3>
              </div>
              <svg
                class="small-box-icon"
                fill="currentColor"
          ...
          <div class="col-lg-6 col-6">
            ...
            <div class="small-box text-bg-secondary">
              <div class="inner">
                <h3>Mahasiswa Jurusan Teknik Elektro</h3>
              </div>
              <svg
               class="small-box-icon"
                fill="orange"
